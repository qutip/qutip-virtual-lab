  ...
  return (
    <div id="details">
      ...
      <ul className="details-tabs">
        <li onClick={() => handleTabClick(tabs.LARMOR)} className={`details-tab ${activeTab === tabs.LARMOR ? 'active' : ''}`}>Larmor Precession</li>
        <li onClick={() => handleTabClick(tabs.DEPHASING)} className={`details-tab ${activeTab === tabs.DEPHASING ? 'active' : ''}`}>Qubit Dephasing</li>
      </ul>
